package com.gt.project.model.exception.handler;

import cn.hutool.extra.mail.MailException;


import com.gt.project.model.common.RestResponse;
import com.gt.project.model.exception.BusinessException;
...
import static com.gt.project.model.common.CodeConstant.*;

/**
 * @author zhoupengbing
 * @packageName com.telecomyt.plat.cmac.exception
...
public class ExceptionHandle {
     ...
     * 正则包名过滤
     */
    private static final String REG_FRAMEWORK_PKG = "com.telecomyt.(?!plat).+";
